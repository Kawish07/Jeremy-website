        ...
        <div className="grid md:grid-cols-2 h-[100vh] md:h-[100vh]">
          <div className="h-full">
            <div
              ...
              style={{
                backgroundImage: `url('https://images.unsplash.com/photo-1479839672679-a46483c0e7c8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHJlYWwlMjBlc3RhdGV8ZW58MHx8MHx8fDA%3D')`,
              }}
            />
          </div>
